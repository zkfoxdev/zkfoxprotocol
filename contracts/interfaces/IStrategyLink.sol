...
interface IStrategyLink {
    ...
    function getPoolInfo(
        ...
        returns (
            ...
            uint256 totalLPRefund
        );

    function getBorrowInfo(
        uint256 _pid,
        address _account
    ) external view returns (address borrowFrom, uint256 bid);
    ...
    function getBorrowAmountInBaseToken(
        uint256 _pid,
        address _account
    ...
    function getPoolCollateralToken(
        uint256 _pid
    ) external view returns (address[] memory collateralToken);
